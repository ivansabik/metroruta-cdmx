function muestraPrincipal() {
    ...
    for(i=0; i<metro.lineas.length; i++) {
        ...
        for(j=0; j<estaciones.length; j++) {
            ...
            htlmListaEstacionesOrigen += '<li><a href="#calcularRuta" onClick="seleccionarEstacionCalcularRuta(\'origen\', '+estaciones[j].id+')"><img src="'+estaciones[j].icono+'" class="ui-li-icon" /><span>'+estaciones[j].nombre+'</span></a></li>';
            htlmListaEstacionesDestino += '<li><a href="#calcularRuta" onClick="seleccionarEstacionCalcularRuta(\'destino\', '+estaciones[j].id+')"><img src="'+estaciones[j].icono+'" class="ui-li-icon" /><span>'+estaciones[j].nombre+'</span></a></li>';
        }
    }
